# Auth & Role Management — Design Spec
...
HaberBot’ta üyelik, rol yönetimi ve yorum altyapısını güvenli bir auth akışıyla devreye almak: Admin ve User rollerini ayırmak, yorum yazmayı User rolüne bağlamak, admin panelini role-based auth ile korumak ve güvenli token/cookie akışıyla giriş/çıkış sağlamak.
